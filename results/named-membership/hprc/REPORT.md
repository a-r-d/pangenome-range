...
Anonymous and named graph queries have identical canonical hashes and two dependency rounds. The registered extension adds 64 graph-query bytes. Identity adds 50,081 membership/provenance bytes and 40,105 catalog bytes. Source-observed scheduling records four cold identity waves: descriptor plus provenance, the membership directory, all four tile pages in parallel, and all three catalog pages in parallel. This misses the aspirational single-extra-round target and is why identity remains experimental.
