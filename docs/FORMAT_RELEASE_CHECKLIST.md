...
| Named identity preview | Final-layout rice/HPRC pilots pass below 1 GiB RSS and graph hashes/rounds match. Whole named-membership chicken and HPRC archives add archive-wide construction, validation, and size evidence; chicken retains the VCF-backed two-tile UCD312 preset. Identity remains experimental. | PASS WITH EXPERIMENTAL STATUS |
