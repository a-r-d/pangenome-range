...
assert.equal(typeof viewer.buildTubeMapModel, "function");
assert.equal(typeof viewer.layoutTubeMap, "function");
assert.equal(typeof viewer.renderTubeMapSvg, "function");
assert.equal(typeof viewer.decideGraphRegion, "function");
...
assert.equal("renderTubeMapSvg" in root, false);
